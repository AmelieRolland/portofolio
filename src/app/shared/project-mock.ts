...
export const projects : Project[] = [
    ...
    { 
        ...
        description: {
            ...
            en: '<p>The idea was to practice my initial SQL skills and get a head start on upcoming PHP courses. <br> 💡 The concept: a random generator of inspiring quotes by women from around the world. The tools used: HTML/CSS Bootstrap, PHP, SQL.</p> <p>The name: “That’s what she said!” is a nod to a series that lifts my spirits in any situation. I have slightly twisted the meaning, of course ;)</p> <p>🍃 Very interested in eco-design, I aimed to create this small site with simplicity, avoiding animations, using native fonts, and converting images to webp format. If you have additional recommendations, I’m open to them!</p> <p>👀 I learned a lot from this project, not just technically. In my desire to share voices that are still undervalued, representing the female figures I missed out on when I was younger, I discovered many women, artists, scientists, writers, whom I had never heard of before; it was a joy to discover them and help make them visible. I still have a list of quotes to add, and if you have any references, feel free to share them with me!</p>'
        },
